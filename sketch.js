...
function preload()
{
  bgsound=createAudio("Underwater.mp3")
...
function setup() {
	createCanvas(displayWidth/1.05,displayHeight/1.05);
	background(200);
...
// shipgroup = new Group();
  ...
  netsprite.addImage('netright',netrightimage)
  netsprite.addImage('netleft',netimage)
